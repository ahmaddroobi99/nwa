...
if compile:
    ...
    extensions =[
        Extension("nwatools.ugridutils",["nwatools/ugridutils.{}".format(ext)],
            include_dirs=[numpy.get_include()],
            extra_compile_args=
                ['-shared', '-pthread', '-fPIC', '-fwrapv', '-O2', '-Wall',
                '-fno-strict-aliasing'],),
        Extension("nwatools.searchutils",["nwatools/searchutils.{}".format(ext)],
            include_dirs=[numpy.get_include()],
...
setup(
    ...
    cmdclass = cmdclass,
    version="0.1.1",
    description='Stuff For NWA Ocean Data Analysis',
    author='Matt Rayson',
